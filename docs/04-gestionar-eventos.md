...
El módulo de gestión de eventos permite programar, editar y eliminar eventos del restaurante. Los eventos son actividades especiales que se muestran en el sistema para promoción e información.
...
- **Estado:** Selecciona el estado del evento
  ...
  - **Inactivo:** El evento no será visible

**Campos Opcionales:**

- **Imagen:** Sube una foto del evento
  - Formatos: JPG, PNG
  - Tamaño máximo: 2MB
  - 💡 La imagen se mostrará en la tarjeta del evento
  
- **Ubicación:** Lugar donde se realizará
  - Ej: "Terraza principal" o "Salón VIP"
  
- **Descripción:** Detalles del evento
  - Ej: "Disfruta de auténticas tapas españolas con bebidas variadas..."
...
6. El evento aparecerá en la lista
...
2. Se mostrará el nombre del evento a eliminar
...
Los eventos pueden estar **Activos** o **Inactivos**:

- **Activo:** Se muestra públicamente en el sistema
- **Inactivo:** No se muestra a los usuarios

### Pasos:
1. Haz clic en **"Editar"** en el evento
...
**Anterior:** [Gestionar Usuarios](03-gestionar-usuarios.md)  
**Siguiente Sección:** [Dashboard del Gerente](05-gerente-dashboard.md)
