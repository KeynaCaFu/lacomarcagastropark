...
El dashboard del gerente proporciona una visión específica del local, mostrando estadísticas e información relevante para la gestión diaria del negocio.
...
### A lo Largo del Día
1. Gestionar productos nuevos
2. Mantener galería de fotos actualizada
3. Actualizar estados de disponibilidad

### Final del Día
1. Revisar estadísticas de ventas
2. Verificar cambios en el inventario
3. Planificar próximos productos

---

**Siguiente Sección:** [Gestionar Productos](06-gestionar-productos.md)  
**Anterior:** [Gestionar Eventos](04-gestionar-eventos.md)
