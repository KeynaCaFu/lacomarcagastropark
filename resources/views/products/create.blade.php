    ...
    <div class="product-form-container">
        <div class="card product-card">
            ...
            <div class="card-body" style="padding:24px;">
                <form action="{{ route('products.store') }}" method="POST" id="productForm" enctype="multipart/form-data" novalidate>
                    @csrf
                    ...
                    <div class="create-product-grid">
                        ...
                        <div class="create-product-left">
                            ...
                            <div class="form-group mb-3">
                                <label for="nombre" class="form-label d-flex align-items-center justify-content-between">
                                    ...
                                    <span class="ms-2 text-white-50" title="El nombre debe ser único. Solo letras. Ejemplo: 'Café Molido'">
                                ...
                                <div>
                                    <div class="form-group mb-3">
                                        <label for="precio" class="form-label d-flex align-items-center justify-content-between">
                                            ...
                                            <span class="ms-2 text-white-50" title="Ingrese un valor mayor a 0. Use decimales con punto (ej: 1500.50)">
                                                <i class="fas fa-info-circle" aria-label="Ayuda"></i>
                                            </span>
                                        </label>
                        ...
                        <div class="create-product-right">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <!-- Preview de imagen -->
                                <div id="imagePreviewContainer" style="margin-top: 12px; border: 2px dashed #e5e7eb; border-radius: 10px; overflow: hidden; background: #fafafa; display: flex; align-items: center; justify-content: center; min-height: 180px; transition: all 0.3s ease;">
                            ...
                            <div class="form-group mb-3">
                                <label for="estado" class="form-label d-flex align-items-center justify-content-between">
                                    ...
                                    <span class="ms-2 text-white-50" title="Seleccione si el producto estará disponible para la venta o no">
                                        <i class="fas fa-info-circle" aria-label="Ayuda"></i>
                                    </span>
                                </label>
                            ...
                            <div style="background: #fffbeb; border: 1px solid #fde68a; border-radius: 8px; padding: 12px 14px; font-size: 13px; color: #92400e;">
                                ...
                                <strong>Tip:</strong> Después de crear el producto podrás agregar más imágenes desde la galería.
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function openCreateProductHelpModal() {
        ...
        if (modal) { modal.style.display = 'flex'; modal.style.pointerEvents = 'auto'; document.body.style.overflow = 'hidden'; }
    }
    function closeCreateProductHelpModal() {
        const modal = document.getElementById('createProductHelpModal');
        if (modal) { modal.style.display = 'none'; modal.style.pointerEvents = 'none'; document.body.style.overflow = 'auto'; }
    }
    window.addEventListener('click', function(e) {
        const modal = document.getElementById('createProductHelpModal');
        if (e.target === modal) closeCreateProductHelpModal();
    });
    document.addEventListener('keydown', function(e) {
        if (e.key === 'Escape') {
            const modal = document.getElementById('createProductHelpModal');
            if (modal && modal.style.display === 'flex') closeCreateProductHelpModal();
        }
    });
    document.addEventListener('DOMContentLoaded', function() {
    ...
    <div class="modal-content" role="dialog" aria-modal="true" aria-labelledby="helpTitle">
        ...
        <div class="modal-body">
            <div class="detail-section">
                ...
                <p>Usa un nombre descriptivo y claro. Ejemplo: "Café Molido"<br>
                <small class="text-muted">Solo letras, sin números. El nombre debe ser único.</small></p>
            </div>
            <div class="detail-section">
                <h5><i class="fas fa-align-left"></i> Descripción</h5>
                <p>Proporciona detalles útiles sobre el producto.<br>
                <small class="text-muted">Incluye ingredientes, origen, características especiales, etc.</small></p>
            </div>
            <div class="detail-section">
                <h5><i class="fas fa-tag"></i> Categoría</h5>
                <p>Usa categorías consistentes. Ejemplos: Bebidas, Alimentos, Postres<br>
                <small class="text-muted">Esto ayuda a organizar mejor los productos.</small></p>
            </div>
            <div class="detail-section">
                <h5><i class="fas fa-leaf"></i> Tipo de Producto</h5>
                <p>Ejemplos: Bebida, Entrada, Plato Principal<br>
                <small class="text-muted">Útil para filtrar productos por tipo.</small></p>
            </div>
            <div class="detail-section">
                <h5><i class="fas fa-money-bill"></i> Precio</h5>
                <p>Ingresa el precio en colones. Ejemplo: 1500.50<br>
                <small class="text-muted">Solo números. El precio debe ser mayor a 0.</small></p>
            </div>
            <div class="detail-section">
            ...
            <div class="detail-section">
                ...
                <p>Selecciona si el producto estará disponible para la venta o no.</p>
            </div>
        </div>
