    ...
    <div style="background:#fff;border-radius:14px;width:100%;max-width:420px;box-shadow:0 8px 32px rgba(0,0,0,.18);overflow:hidden;">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;padding:18px 20px;border-bottom:1px solid #e5e7eb;">
            <h5 style="margin:0;font-weight:700;font-size:17px;color:#111827;">
                <i class="fas fa-plus-circle" style="color:#e18018;margin-right:8px;"></i>Nuevo Local
            </h5>
            <button id="btnCloseCreateLocal" type="button"
                    style="background:none;border:none;cursor:pointer;font-size:20px;color:#6b7280;line-height:1;">&times;</button>
        </div>
        <!-- Modal body -->
        <form id="formCrearLocal" method="POST" action="{{ route('locales.store') }}" style="padding:20px;" novalidate>
            @csrf
            <div style="margin-bottom:16px;">
                <label style="display:block;font-size:13px;font-weight:600;color:#374151;margin-bottom:6px;">
                    Nombre del local <span style="color:#dc2626;">*</span>
                </label>
                <input type="text" id="create_local_name" name="name" maxlength="255"
                ...
                <div class="field-error" id="create_local_nameError" style="display:none;"><i class="fas fa-exclamation-circle"></i> <span></span></div>
            </div>
            <div style="margin-bottom:24px;">
                <label style="display:block;font-size:13px;font-weight:600;color:#374151;margin-bottom:6px;">
                    Gerente asignado <span style="color:#dc2626;">*</span>
                </label>
                <select id="create_manager_id" name="manager_id"
                ...
                <div class="field-error" id="create_manager_idError" style="display:none;"><i class="fas fa-exclamation-circle"></i> <span></span></div>
            </div>
            <div style="display:flex;gap:10px;justify-content:flex-end;">
                <button type="button" id="btnCloseCreateLocal2"
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-save" style="margin-right:6px;"></i>Crear Local
                </button>
            </div>
        </form>
    </div>
